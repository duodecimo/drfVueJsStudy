<template>
  <div>
    ...
    <!-- fixed-header, para funcionar, precisa que a altura(height) do componente seja definida -->
    <v-data-table
      height="500"
      :headers="headers"
      :items="desserts"
    ...
    >
      ...
      <template v-slot:[`item.iron`]="props">
        <!-- https://vuetifyjs.com/en/api/v-edit-dialog/#props   -->
        <v-edit-dialog
